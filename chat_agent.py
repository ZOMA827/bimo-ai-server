...
• ⚠️ قاعدة النطق الحيوية: لكي يستطيع نظام النطق الخاص بك قراءة كلامك بدون أخطاء، **يجب عليك كتابة أي كلمة أجنبية أو تقنية بحروف عربية**.
(مثال: اكتب "فايربيس" بدلاً من Firebase، واكتب "سولو ليفلينغ" بدلاً من Solo Leveling، واكتب "أوكي" بدلاً من OK).
